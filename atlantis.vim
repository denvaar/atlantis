...
"call s:HL('DiffAdd',                        s:color2,    s:gray2,    'none')
"call s:HL('DiffChange',                     s:color3,   s:gray2,    'none')
"call s:HL('DiffDelete',                     s:color1,      s:gray2,    'none')
"call s:HL('DiffText',                       s:color4,     s:gray2,    'none')
...
"call s:HL('PmenuSel',                       s:gray2,    s:color6,     '')
"call s:HL('PmenuThumb',                     '',         s:gray4,    '')
"call s:HL('Question',                       s:color4,     '',         'none')
"call s:HL('SignColumn',                     s:gray5,    s:gray1,    '')
"call s:HL('SpellBad',                       s:color1,      s:gray2,    'undercurl')
"call s:HL('SpellCap',                       s:color4,     s:gray2,    'undercurl')
...
"call s:HL('WildMenu',                       s:gray2,    s:color6,	    '')
...
call s:HL('Comment', s:gray4, 'none', 'italic')
...
call s:HL('Operator', s:gray2, 'none', 'none')
...
" Elixir
"call s:HL('elixirBlock', s:gray2, 'none', 'none')
...
call s:HL('javascriptBlock', s:gray2, '', 'none')
...
call s:HL('javascriptOpSymbols', s:gray2, '', 'none')
call s:HL('javascriptParenTagLiteral', s:gray2, '', 'none')
call s:HL('javascriptParens', s:gray2, '', 'none')
...
call s:HL('jsonBraces', s:gray2, 'none', 'none')
